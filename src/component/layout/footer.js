...
import searchBtn from "../../assets/images/widget-search-btn.svg";
import fshape from "../../assets/images/f-shape.png";
const Footer = () => {
  return (
    <footer className="footer-section section-padding pb-0">
        ...
        <div className="container">
          <div className="wraper">
            <h2 className="scroll-text-animation">
              <span>New Creative Ideas</span> <br />
              send me an e-mail –{" "}
              <span className="color">  info@example.com</span>
            </h2>
            <a
              href="contact.html"
              className="topbar-btn scroll-text-animation btn-wrapper btn-move"
      ...
      <div className="container">
        <div className="footer">
              ...
              <form className="form-fild">
                ...
                <div className="terms">
                  ...
                  <label for="checkbox" className="checkbox-label">
                    <span className="custom-checkbox"></span>I agree to all your
                    terms and policies
                  </label>
                </div>
              </form>
          ...
          <div className="item fade_bottom">
            ...
            <ul>
              <li>
                <a href="service-single.html">About Company</a>
              </li>
              <li>
                <a href="service-single.html">Case Study</a>
              </li>
              <li>
                <a href="service-single.html">Our Careers</a>
              </li>
              <li>
                <a href="service-single.html">Our Blogs</a>
              </li>
              <li>
      ...
      <div className="footer-lower fade_bottom">
        <div className="container">
          <div className="row align-items-center g-0">
            <div className="col-lg-5 col-12">
              <p className="copyright">
                Copyright &copy; <span>2025</span> wpocean by All rights
                reserved.
              </p>
            </div>
